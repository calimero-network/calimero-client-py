/* Python SDK Docs — Shared Navigation + Full-text Search */
(function () {
  'use strict';

  const REPO = 'https://github.com/calimero-network/calimero-client-py';
  const PAGES_BASE = './';
  ...
  const NAV = [
    ...
    { section: 'Reference' },
    { label: 'Client',             href: 'client.html',       dot: '#58a6ff' },
    { label: 'RPC',                href: 'rpc.html',          dot: '#f0883e' },
    { label: 'Aliases',            href: 'aliases.html',      dot: '#39d0d8' },
    { label: 'Namespaces & Groups',href: 'namespaces.html',   dot: '#f778ba' },
    { label: 'ConnectionInfo',     href: 'connection.html',   dot: '#3fb950' },
    { label: 'Types',              href: 'types.html',        dot: '#a371f7' },
  ];
    ...
    sb.innerHTML = `
      <div class="sidebar-logo">
        <div class="sidebar-logo-inner">
          ...
          <div class="sidebar-logo-text">
            <strong>Calimero <em>Client Py</em></strong>
      ...
      <div class="sidebar-footer">
        ...
        <div class="sidebar-footer-links">
          <a href="https://github.com/calimero-network/calimero-client-py" target="_blank" rel="noopener">
  ...
  function searchDocs(query, index) {
    ...
    return index
      .map((page) => {
        ...
        return { ...page, excerpt, score: (titleMatch ? 2 : 0) + (headingMatch ? 1 : 0) + (excerpt ? 0.5 : 0) };
      })
      .filter(Boolean)
      ...
      input.addEventListener('input', () => {
        ...
        debounceTimer = setTimeout(async () => {
          ...
          if (!searchIndex && !searchLoading)
            document.getElementById('search-results').innerHTML = '<p class="search-hint search-loading">Loading index…</p>';
