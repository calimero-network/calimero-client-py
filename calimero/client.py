...
class CalimeroClient:
    ...
    async def create_context(self, application_id: str, protocol: str = "near", initialization_params: list = None) -> CreateContextResponse:
        ...
        return await self.admin.create_context(application_id, protocol, initialization_params or [])
    ...
    async def invite_to_context(self, context_id: str, granter_id: str, grantee_id: str, capability: str = "member"):
        """Invite an identity to a context (workflow compatibility)."""
        return await self.admin.invite_to_context(context_id, granter_id, grantee_id, capability)
