...
class CreateContextRequest(BaseRequest):
    ...
    application_id: str = Field(description="The ID of the application to run in the context")
    protocol: str = Field(default="near", description="The protocol to use for the context")
    initialization_params: List[Any] = Field(default_factory=list, description="Optional initialization parameters")
...
class CreateContextResponse(SuccessResponse):
    ...
    context_id: Optional[str] = Field(default=None, description="The ID of the created context")
    member_public_key: Optional[str] = Field(default=None, description="The public key of the context member")
...
class ContextInfo(BaseModel):
    ...
    created_at: Optional[datetime] = Field(default=None, description="When the context was created")
    member_count: Optional[int] = Field(default=None, description="Number of members in the context")
...
class GenerateIdentityResponse(SuccessResponse):
    ...
    context_id: Optional[str] = Field(default=None, description="Context ID if generated in a context")


class IdentityInfo(BaseModel):
    """Information about an identity."""
    public_key: str = Field(description="Identity public key")
    context_id: Optional[str] = Field(default=None, description="Context ID if part of a context")
    capabilities: List[str] = Field(default_factory=list, description="Capabilities of the identity")
    created_at: Optional[datetime] = Field(default=None, description="When the identity was created")
...
class InviteToContextRequest(BaseRequest):
    ...
    inviter_id: str = Field(description="The public key of the inviter (context member)")
...
class InviteToContextResponse(SuccessResponse):
    ...
    expires_at: Optional[datetime] = Field(default=None, description="When the invitation expires")
...
class JoinContextRequest(BaseRequest):
    ...
    invitee_id: str = Field(description="The public key of the identity joining the context")
    invitation_payload: str = Field(description="The invitation data/token to join the context")
...
class InstallApplicationRequest(BaseRequest):
    ...
    hash: Optional[str] = Field(default=None, description="Optional hash for verification")
    metadata: bytes = Field(default=b"", description="Application metadata as bytes")
...
class InstallApplicationResponse(SuccessResponse):
    ...
    hash: Optional[str] = Field(default=None, description="Hash of the installed application")
...
class ApplicationInfo(BaseModel):
    ...
    installed_at: Optional[datetime] = Field(default=None, description="When the application was installed")
...
class UninstallApplicationResponse(SuccessResponse):
    ...
    uninstalled_application_id: str = Field(description="ID of the uninstalled application")
...
class BlobInfo(BaseModel):
    ...
    uploaded_at: Optional[datetime] = Field(default=None, description="When the blob was uploaded")
...
class GetContextStorageEntriesResponse(SuccessResponse):
    ...
    total_count: int = Field(description="Total number of entries matching the criteria")
...
class ProposalInfo(BaseModel):
    ...
    created_at: Optional[datetime] = Field(default=None, description="When the proposal was created")
    expires_at: Optional[datetime] = Field(default=None, description="When the proposal expires")
...
class GetProposalsRequest(BaseRequest):
    ...
    limit: int = Field(default=100, description="The maximum number of proposals to return")
...
class AliasInfo(BaseModel):
    ...
    created_at: Optional[datetime] = Field(default=None, description="When the alias was created")
...
class PeerInfo(BaseModel):
    ...
    connected_at: Optional[datetime] = Field(default=None, description="When the peer connected")
...
class GetCertificateResponse(SuccessResponse):
    ...
    expires_at: Optional[datetime] = Field(default=None, description="When the certificate expires")


class SyncContextResponse(SuccessResponse):
    """Response from syncing a context."""
    context_id: Optional[str] = Field(default=None, description="Context ID that was synced")
...
class JsonRpcExecuteRequest(BaseRequest):
    ...
    args_json: Dict[str, Any] = Field(default_factory=dict, description="Method arguments as JSON")
...
class JsonRpcResponse(BaseResponse):
    ...
    error: Optional[JsonRpcErrorInfo] = Field(default=None, description="Error information")
...
class SubscribeRequest(BaseRequest):
    ...
    application_ids: List[str] = Field(description="List of application IDs to subscribe to")


class UnsubscribeRequest(BaseRequest):
    """Request to unsubscribe from application updates."""
    application_ids: List[str] = Field(description="List of application IDs to unsubscribe from")
...
JsonRpcApiResponse = Union[
    JsonRpcResponse,
    ErrorResponse
]

# WebSocket response types
WebSocketApiResponse = Union[
    WebSocketMessage,
    SubscriptionUpdate,
    ErrorResponse
]
